    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if ($rq_sec['admin']=='1' OR $rq_sec['admin_doc']=='1' OR $rq_sec['doc']=='1'){ ?>
            <li><a href="./pages/doc_documentos.php"><i class="fa fa-file"></i> <span>Documentación</span></a></li>
        <?php } ?>          
        <?php if ($rq_sec['admin']=='1' OR $rq_sec['compliance']=='1'){ ?>
          <li><a href="./pages/procesos.php"><i class="fa fa-gear"></i> <span>Procesos</span></a></li>
        ...
        <?php if ($rq_sec['admin']=='1' OR $rq_sec['soc']=='1'){
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./pages/cdc_costos.php"><i class="fa fa-calculator"></i> Cotizador Online</a></li>
                <?php if ($rq_sec['admin_cli_dc']=='1'){ ?>
                    <li><a href="./pages/cdc_costos_productos.php"><i class="fa fa-bars"></i>Productos</a></li>
                <?php } ?>
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="./pages/sdc_storage.php"><i class="fa fa-database"></i> Storage</a></li>
                  </ul>
                </li>
              </ul>
            </li>    
