            ...
            <div class="box-header">
				<div class="col-sm-6" style="text-align:left">
 				...
 				<div class="col-sm-6" style="text-align:right;">
					<button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#modal-control"><i class="fa fa-retweet"></i> Nuevo Control</button>
            ...
            <form method="post" role="form" action="">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="titulo" placeholder="Título del control" required>
                </div>
                <div class="form-group">
                  <label for="descripcion">Contenido</label>
                  <textarea class="form-control" rows="3" name="contenido" placeholder="Contenido del control ..." required></textarea>
                </div>
				<div class="form-group">
        ...
        <!-- /.modal Persona -->
			...
			<div class="box-body">
              <table id="controles" class="table table-bordered table-hover">
                ...
                <tbody>
					<?php
					$query = "SELECT * FROM controles as i LEFT JOIN persona as p on responsable = p.id_persona
							  WHERE i.borrado='0'";
					...
					if(mysqli_num_rows($sql) == 0){
						...
						while($row = mysqli_fetch_assoc($sql)){
							...
							<tr>
							<td>
							<a href="control.php?nik='.$row['id_control'].'"><span class="fa fa-retweet" aria-hidden="true"></span></a></td>
