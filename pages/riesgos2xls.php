      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="myTab">
              <li class="active"><a href="#tab_1" data-toggle="tab">Riesgos</a></li>
              <li><a href="#tab_2" data-toggle="tab">Métricas</a></li>
            </ul>
              ...
              <div class="tab-pane active" id="tab_1">
                <div class="box">
 				...
 				<div class="col-sm-6" style="text-align:right;">
                    <button type="button" class="btn-sm" data-toggle="modal" data-target="#modal-ciclo"><i class="glyphicon glyphicon-repeat"></i> Ciclo</button>
                    <button type="button" class="btn-sm" data-toggle="modal" data-target="#modal-inherente"><i class="glyphicon glyphicon-th"></i> Inherente</button>
                    <button type="button" class="btn-sm" data-toggle="modal" data-target="#modal-residual"><i class="glyphicon glyphicon-th"></i> Residual</button>
                    <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#modal-riesgo"><i class="glyphicon glyphicon-flash"></i> Nuevo Riesgo</button>
        ...
        <div class="modal-body">
					...
					<div class="box-body">
						<div class="col-md-6">
                            <div class="form-group">
								<label class="label-custom label-custom-info">Identificador</label>
									<input type="text" name="id_riesgo" value="<?php echo $next_id; ?>" readonly class="form-control">
							</div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date" data-provide="datepicker1">
                              ...
                              <input type="text" class="form-control pull-right" name="alta" id="datepicker1" placeholder="dd/mm/yyyy">
                            </div>
                      </div>
                        </div>
                        <div class="form-group">
							<label for="amenaza"> Amenaza</label>
							<textarea class="form-control" rows="2" name="amenaza" placeholder="Amenaza ..." required></textarea>
						</div>
						<div class="form-group">
						  <label for="vulnerabilidad"> Vulnerabilidad</label>
						  <textarea class="form-control" rows="2" name="vulnerabilidad" placeholder="Vulnerabilidad ..." required></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-row">
                          ...
                          <div class="form-group">
                              ...
                              <label class="label-custom label-custom-info">Control existente / propuesto</label>
								<input type="text" name="control" value="<?php echo $row ['control']; ?>" class="form-control" placeholder="Control existente ...">
							</div>
                       ...
                       <div class="col-lg-6">         
                            <div class="form-group">
                                    ...
                                    <div class="input-group date" data-provide="datepicker2">
                                      ...
                                      <input type="text" class="form-control pull-right" name="vencimiento" id="datepicker2" placeholder="dd/mm/yyyy">
                                    </div>
                              </div>
                                </div>
                            </div>
							<div class="form-group">
								<label class="label-custom label-custom-info">Plan de tratamiento</label>
									<input type="text" name="plan" value="<?php echo $row ['plan']; ?>" class="form-control" >
							</div>
							<div class="row">
								<div class="col-lg-6">
			...
			<div class="form-group">
					...
					<div class="col-sm-12">
						<textarea class="form-control" rows="2" name="observacion" placeholder="Observaciones ..." ></textarea><br>
					</div>
			</div>
                    ...
                    <div align=center>
                      <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
                         ...
                         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
                          <td width=30 valign=top style='width:16.6pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><o:p>&nbsp;</o:p></p>
                          </td>
                          <td width=114 style='width:85.7pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><o:p>&nbsp;</o:p></p>
                          </td>
                          <td width=387 colspan=4 style='width:289.95pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>PROBABILIDAD DE OCURRENCIA<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><o:p>&nbsp;</o:p></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:1'>
                          ...
                          <td width=98 style='width:73.3pt;border:none;border-bottom:solid windowtext 1.0pt;
                          mso-border-bottom-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>IMPROBABLE</p>
                          </td>
                          <td width=99 style='width:74.3pt;border:none;border-bottom:solid windowtext 1.0pt;
                          mso-border-bottom-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>MODERADA</p>
                          </td>
                          <td width=96 style='width:72.3pt;border:none;border-bottom:solid windowtext 1.0pt;
                          mso-border-bottom-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>PROBABLE</p>
                          </td>
                          <td width=93 style='width:70.05pt;border:none;border-bottom:solid windowtext 1.0pt;
                          mso-border-bottom-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>CERTEZA</p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:2;height:63.3pt'>
                          <td width=30 rowspan=4 style='width:16.6pt;border:none;padding:0cm 5.4pt 0cm 5.4pt;
                          height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>I<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>M<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>P<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>A<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>C<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>T<o:p></o:p></span></p>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><span style='font-size:14.0pt;
                          mso-bidi-font-size:11.0pt'>O</span></p>
                          </td>
                          <td width=114 style='width:85.7pt;border:none;border-right:solid windowtext 1.0pt;
                          mso-border-right-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;
                          height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>CATASTRÓFICO</p>
                          </td>
                          <td width=98 style='text-align:center; width:73.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:yellow;padding:0cm 5.4pt 0cm 5.4pt;
                          height:63.3pt'>
                          <a href="riesgos.php?aksi=filter&t=0&p=1&i=4" style="display:contents">
                          <div class="box_a" style="color:black"><?php echo $row14['q14']; ?></div></a>
                          </td>
                          <td width=99 style='text-align:center; width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.3pt'>
                          <a href="riesgos.php?aksi=filter&t=0&p=2&i=4" style="display:contents">
                          <div class="box_a" style="color:black"><?php echo $row24['q24']; ?></div></a>
                          </td>
                          ...
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row34['q34']; ?></p>
                          </td>
                          ...
                          height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row44['q44']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:3;height:63.4pt'>
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>MAYOR</p>
                          </td>
                          <td width=98 style='width:73.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:#00B050;padding:0cm 5.4pt 0cm 5.4pt;
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row13['q13']; ?></p>
                          </td>
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row23['q23']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row33['q33']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row43['q43']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:4;height:70.8pt'>
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>MODERADO</p>
                          </td>
                          <td width=98 style='width:73.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row12['q12']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row22['q22']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row32['q32']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row42['q42']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:5;mso-yfti-lastrow:yes;height:62.4pt'>
                          <td width=114 style='width:85.7pt;border:none;border-right:solid windowtext 1.0pt;
                          mso-border-right-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'>MENOR</p>
                          </td>
                          <td width=98 style='width:73.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row11['q11']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row21['q21']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row31['q31']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row41['q41']; ?></p>
                          </td>
                         </tr>
                        </table>
                    ...
                    <div align=center>
                      <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
                         ...
                         <tr style='mso-yfti-irow:2;height:63.3pt'>
                          ...
                          height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row14r['q14r']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row24r['q24r']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row34r['q34r']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:63.3pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row44r['q44r']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:3;height:63.4pt'>
                          <td width=114 style='width:85.7pt;border:none;border-right:solid windowtext 1.0pt;
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row13r['q13r']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row23r['q23r']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          solid windowtext .5pt;background:red;padding:0cm 5.4pt 0cm 5.4pt;height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row33r['q33r']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:63.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row43r['q43r']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:4;height:70.8pt'>
                          <td width=114 style='width:85.7pt;border:none;border-right:solid windowtext 1.0pt;
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row12r['q12r']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row22r['q22r']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row32r['q32r']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:70.8pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row42r['q42r']; ?></p>
                          </td>
                         </tr>
                         <tr style='mso-yfti-irow:5;mso-yfti-lastrow:yes;height:62.4pt'>
                          <td width=114 style='width:85.7pt;border:none;border-right:solid windowtext 1.0pt;
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row11r['q11r']; ?></p>
                          </td>
                          <td width=99 style='width:74.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row21r['q21r']; ?></p>
                          </td>
                          <td width=96 style='width:72.3pt;border-top:none;border-left:none;border-bottom:
                          solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
                          solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row31r['q31r']; ?></p>
                          </td>
                          <td width=93 style='width:70.05pt;border-top:none;border-left:none;
                          border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                          mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
                          ...
                          height:62.4pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
                          text-align:center;line-height:normal'><?php echo $row41r['q41r']; ?></p>
                          </td>
                         </tr>
                        </table>
		...
		<div id="ver-itemDialog" class="modal fade">
			<div class="modal-dialog" style="width:900px;">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							<label for="amenaza"> Amenaza</label>
							<textarea class="form-control" rows="2" id="amenaza" value="" readonly></textarea>
						</div>
						<div class="form-group">
						  <label for="vulnerabilidad"> Vulnerabilidad</label>
						  <textarea class="form-control" rows="2" id="vulnerabilidad" value="" readonly></textarea>
						</div>
						<div class="form-group">
							<label>Activos afectados</label>
							<input type="text" class="form-control" name="activos" id="activos" value="" readonly>
						</div>
					</div>
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label class="label-custom label-custom-info">Probabilidad de ocurrencia</label>
								<input type="text" class="form-control" name="prob" id="prob" value="" readonly>
						</div>
						<div class="form-row">
							<div class="col-sm-4">
								<label class="label-custom label-custom-info" style="text-align:center;">Impacto en confidencialidad</label>
						...
						<div class="form-row">
								<div class="col-sm-4">
									<input type="text" class="form-control" name="i_conf" id="i_conf" value="" readonly>
								</div>
								<div class="col-sm-4">
									<input type="text" class="form-control" name="i_int" id="i_int" value="" readonly>
								</div>
								<div class="col-sm-4">
									<input type="text" class="form-control" name="i_disp" id="i_disp" value="" readonly>
								</div>
						</div><br>
                        <div class="form-row">
							<div class="col-sm-4">
								<label class="label-custom label-custom-info" style="text-align:center;">Impacto resultante</label>
							</div>
							<div class="col-sm-4">
								<label class="label-custom label-custom-info" style="text-align:center;">Riesgo Inherente</label>
							</div>
							<div class="col-sm-4">
								<label class="label-custom label-custom-info" style="text-align:center;">Valoración Riesgo</label>
							</div>
						</div>
						<div class="form-row">
								<div class="col-sm-4">
									<input type="text" class="form-control" name="i_result" id="i_result" value="" readonly>
								</div>
								<div class="col-sm-4">
									<input type="text" class="form-control" name="n_riesgo" id="n_riesgo" value="" readonly>
								</div>
								<div class="col-sm-4">
									<input type="text" class="form-control" name="valoracion" id="valoracion" value="" readonly>
								</div>
						</div><br>
					</div>
			</div>
			...
			<div class="col-md-6">
				<div class="box box-default">
						...
						<div class="box-body">
							<div class="form-group">
								<label class="label-custom label-custom-info">Control existente / propuesto</label>
								<input type="text" class="form-control" name="control" id="control" value="" readonly>
							</div>
							<div class="form-group">
                                   <label class="label-custom label-custom-info">Tipo de control</label>
                                    <input type="text" class="form-control" name="t_control" id="t_control" value="" readonly>					
 							</div>
							<div class="form-group">
								<label class="label-custom label-custom-info">Estrategia propuesta</label>
								<input type="text" class="form-control" name="estrategia" id="estrategia" value="" readonly>
							</div>
							<div class="form-group">
								<label class="label-custom label-custom-info">Plan de tratamiento</label>
									<input type="text" class="form-control" name="plan" id="plan" value="" readonly>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<label class="label-custom label-custom-info" style="text-align:center;">Probabilidad residual</label>
									<input type="text" class="form-control" name="p_resid" id="p_resid" value="" readonly>
								  <!-- /input-group -->
								</div>
                <!-- /.col-lg-6 -->
								<div class="col-lg-6">
								  <div class="input-group">
									<label class="label-custom label-custom-info" style="text-align:center;">Impacto residual</label>
									<input type="text" class="form-control" name="i_resid" id="i_resid" value="" readonly>
								  </div>
								  <!-- /input-group -->
								</div>
                <!-- /.col-lg-6 -->
                            ...
                            <div class="row">
								<div class="col-lg-6">
									<label class="label-custom label-custom-info" style="text-align:center;">Riesgo residual</label>
									<input type="text" class="form-control" name="n_resid" id="n_resid" value="" readonly>
								  <!-- /input-group -->
								</div>
                <!-- /.col-lg-6 -->
								<div class="col-lg-6">
								  <div class="input-group">
									<label class="label-custom label-custom-info" style="text-align:center;">Valoración residual</label>
									<input type="text" class="form-control" name="val_resid" id="val_resid" value="" readonly>
								  </div>
								  <!-- /input-group -->
								</div>
                <!-- /.col-lg-6 -->
			...
			<div class="form-group">
					<div class="col-sm-12">
						<label class="label-custom label-custom-info">Observaciones</label>
                        <textarea class="form-control" rows="2" name="observacion" id="observacion" value="" readonly></textarea><br>
					</div>
			</div>
            <div class="modal-footer">
                ...
                <tbody>
					...
					if(mysqli_num_rows($sql) == 0){
						...
						while($row = mysqli_fetch_assoc($sql)){
							...
							<tr>
							<td>
							<a data-id="'.$row['id_riesgo'].'" 
								data-amenaza="'.$row['amenaza'].'"
								data-vulnerabilidad="'.$row['vulnerabilidad'].'"
								data-activos="'.$character.'"
								data-responsable="'.$row['apellido'].' '.$row['nombre'].'"
								data-categoria="'.$row['tipo'].'"
								data-nivel="'.$row['n_riesgo'].'"
								data-valoracion="'.$row['valoracion'].'"
								data-t_control="'.$row['t_control'].'"
								data-plan="'.$row['plan'].'"
                                data-prob="'.$row['probabilidad'].'"
                                data-i_conf="'.$row['i_conf'].'"
                                data-i_int="'.$row['i_int'].'"
                                data-i_disp="'.$row['i_disp'].'"
                                data-control="'.$row['control'].'"
                                data-estrategia="'.$row['estrategia'].'"
                                data-p_resid="'.$row['p_resid'].'"
                                data-i_resid="'.$row['i_resid'].'"
                                data-observacion="'.$row['observacion'].'"
                                data-n_riesgo="'.$row['n_riesgo'].'"
                                data-n_resid="'.$row['n_resid'].'"
                                data-val_resid="'.$row['val_resid'].'"
                                data-i_result="'.$row['i_result'].'"
                                data-v_inicial="'.$row['v_inicial'].'"
                                data-alta="'.$row['alta'].'"
                                data-identificado="'.$row['identificado'].'"
                                data-resolucion="'.$row['resolucion'].'"
                                data-incidente="'.$row['incidente'].'"
                                data-avance="'.$row['avance'].'"
                                data-vencimiento="'.$row['vencimiento'].'"
                                data-plazo="'.$row['plazo'].'"
                                title="ver datos" class="ver-itemDialog btn btn-sm"><i class="glyphicon glyphicon-eye-open"></i></a>
							</td>';*/
							echo '
							
							
							<td align="center">'.$row['id_riesgo'].'</td>';
							...
							//echo '<td>';
							//while($aclist = mysqli_fetch_array($sqlq)){
                                //echo $aclist['titulo'];
									//echo '<br>';
								//	}
							//echo '</td>';
                   ...
                   <div class="col-lg-3 col-xs-6">
                       <div class="box box-info">
                            <div class="box-header with-border">
                              <h3 class="box-title">Abiertos en plazo/vencidos</h3>
...
<script>
    window.onload = function() {
        history.replaceState("", "", "riesgos2xls.php");
    }
</script>
<script>
$(function(){
