<div class="modal fade" id="modal-import-hosting">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title" id='modal-import-hosting-title'>Importación Planilla de disponibilidad</h2>
        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <input id="modal-import-hosting-file" type="file" accept=".xlsx" name="image" />
                                <p class="help-block">El archivo debe ser ingresado en formato XLSX.</p>
                            </div>
                            <div class="form-group">
