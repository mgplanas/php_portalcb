$(function() {
    ...
    $('#tbgerencias tbody').on('click', 'tr', function() {
        ...
        let idgerencia = tbgerenciasDT.row(this).data()[0];
    ...
    function refreshGerencias() {
        // Limpio tablas
        tbgerencias.DataTable().clear().draw();
        tbsubgerencias.DataTable().clear().draw();
        tbareas.DataTable().clear().draw();
        ...
        $.ajax({
            ...
            success: function(json) {
                myJsonData = json;
                populateDataTable(myJsonData, tbgerencias, 'modal-abm-gerencia-btn-edit');
                setGerenciaTriggers();
            },
    ...
    function refreshSubGerencias(idgerencia) {
        ...
        $.ajax({
            ...
            success: function(json) {
                myJsonData = json;
                populateDataTable(myJsonData, tbsubgerencias, 'modal-abm-subgerencia-btn-edit');
    ...
    function refreshAreas(idsubgerencia) {
        ...
        $.ajax({
            ...
            success: function(json) {
                myJsonData = json;
                populateDataTable(myJsonData, tbareas, 'modal-abm-area-btn-edit');
