  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="cdc_costos.php"><i class="fa fa-calculator"></i> Cotizador Online</a></li>
        <?php if ($rq_sec['admin_cli_dc']=='1'){ ?>
            <li><a href="cdc_costos_productos.php"><i class="fa fa-bars"></i>Productos</a></li>
        <?php } ?> 
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="sdc_housing.php"><i class="fa fa-home"></i> Todos</a></li>
                    <li><a href="sdc_housing_telco.php"><i class="fa fa-phone"></i> TELCO</a></li>
                </ul>
            </li>
