...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	<section class="content-header">
      <h1>Servicios de Housing [TELCO]</h1>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            <div class="box-header">
				<div class="col-sm-6" style="text-align:left">
					<h2 class="box-title">Listado de Servicios Telco</h2>
				</div>
         <div class="col-sm-6" style="text-align:right;">
          <?php if ($rq_sec['admin']=='1' OR $rq_sec['admin_cli_dc']=='1'){ ?>
          <button type="button" id="modal-abm-housing-telco-btn-alta" data-telco="1" class="btn-sm btn-primary" data-toggle="modal" data-target="#modal-activo"><i class="fa fa-home"></i> Nuevo Servicio de Housing TELCO</button>
          <?php } ?>
				</div>
            </div>
			...
			<div class="box-body">
              <table id="clientes" class="table table-bordered table-hover">
                ...
                <tbody>
					<?php
					$query = "SELECT * FROM vw_sdc_housing_telco;"; 
              ...
              if ($rq_sec['admin']=='1' OR $rq_sec['admin_cli_dc']=='1'){ 
                echo '<a 
                  ...
                  title="Editar Servicio" class="modal-abm-housing-telco-btn-edit btn btn-sm"><i class="glyphicon glyphicon-edit"></i></a>
                <a href="sdc_housing_telco.php?aksi=delete&nik='.$row['id'].'" title="Borrar Servicio" onclick="return confirm(\'Esta seguro de borrar el servicio de Housing?\')" class="btn btn-sm"><i class="glyphicon glyphicon-trash"></i></a>';
              }
              echo '</td>
              </tr>';
						}
