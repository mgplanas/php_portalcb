              ...
              <div class="tab-pane active" id="tab_1">
                <table id="permisos" class="table table-bordered table-hover">
                    <div class="col-sm-12" style="text-align:right;">
					   <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#modal-acceso"><i class="glyphicon glyphicon-user"></i> Nuevo Acceso</button>
				    </div>
                <thead>
                <tr>
                  <th width="1">Nro</th>
                ...
                <tbody>
					...
					if(mysqli_num_rows($sql) == 0){
						...
						while($row = mysqli_fetch_assoc($sql)){
							...
							<td align="center">'.$row['id_permiso'].'</td>';
                            ...
                            <label>
					           <a href=#><input name="admin" type="checkbox" onclick="updatePerm(1, '.$row['id_permiso'].');" value="1"'; if($row['admin'] == '1'){ echo 'checked'; } echo'></a>
                            </label>
                            </div></td>
							'; 
                            echo '
							...
							<td><div class="checkbox">
                            <label>
					           <input name="soc" type="checkbox" onclick="updatePerm(2, '.$row['id_permiso'].');" value="1"'; if($row['soc'] == '1'){ echo 'checked'; } echo'> 
                            </label>
                            </div></td>
							'; 
                            echo '
							...
							<td><div class="checkbox">
                            <label>
					           <input name="compliance" type="checkbox" onclick="updatePerm(3, '.$row['id_permiso'].');" value="1"'; if($row['compliance'] == '1'){ echo 'checked'; } echo'> 
                            </label>
                            </div></td>
							'; 
                            echo '
							...
							<td><div class="checkbox">
                            <label>
					           <input name="edicion" type="checkbox" onclick="updatePerm(4, '.$row['id_permiso'].');" value="1"'; if($row['edicion'] == '1'){ echo 'checked'; } echo'> 
                            </label>
                            </div></td>
							'; 
                            echo '
              ...
              <div class="box-body">
                <div class="form-group">
                 ...
                 <label>Permisos</label>
                  <div class="checkbox">
                    <label>
                       <input name="lectura" type="checkbox" value="1"> Solo lectura
                    </label>
                 </div>
                  <div class="checkbox">
                    <label>
                       <input name="edicion" type="checkbox" value="1"> Edición (Borrar ítems)
                    </label>
                 </div>
                  <div class="checkbox">
                    <label>
                       <input name="compliance" type="checkbox" value="1"> Compliance (Riesgos, Activos, ISO 27001, Controles)
                    </label>
                 </div>
                  <div class="checkbox">
                    <label>
                       <input name="soc" type="checkbox" value="1"> SOC (Operaciones de Ciberseguridad)
                    </label>
                 </div>
