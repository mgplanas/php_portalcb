<?php
    ...
    switch ($op) {
        case 'A':
            // INSERT
            $insert_evento = mysqli_query($con, "INSERT INTO adm_eventos_cal (borrado,color,descripcion,estado,fecha_fin,fecha_inicio,id,id_persona,is_all_day,is_background,is_programmed,observaciones,subtipo,tipo)
                                                VALUES (0,'$color','$descripcion','$estado','$fecha_fin','$fecha_inicio','$id','$id_persona','$is_all_day','$is_background','$is_programmed','$observaciones','$subtipo','$tipo')") or die(mysqli_error());	
