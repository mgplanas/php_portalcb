  $(function () {
    ...
    header    : {
      ...
      eventDrop: function(event, delta){ // event drag and drop
           $.ajax({
               url: 'calendario_guardias.php',
               data: 'action=update&title='+event.title+'&start='+moment(event.start).format()+'&end='+moment(event.end).format()+'&id='+event.id_calendario,
               type: "POST",
      ...
      /*
      select: function(start, end, jsEvent) {  // click on empty time slot to add event
